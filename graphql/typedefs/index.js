...
export default () => {
  ...
  """ The implementation for this scalar is provided by the GraphQLUpload' export from the 'graphql-upload' package in the resolver map below"""
    ...
    type Query {
      ...
      """ Өөрийн харилцаж болох бүх группууд ирнэ, client tal deerh data n oorclogdson esehiig medeh zorilgtoi """
      checkSyncGroups: [checkSyncGroupResponse!]
